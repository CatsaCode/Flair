...
void Flare::ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem, para1Type para1Name) { \
...
void Flare::ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem, para1Type para1Name, para2Type para2Name) { \
...
void Flare::ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem, para1Type para1Name, para2Type para2Name, para3Type para3Name, para4Type para4Name) { \
...
returnType Flare::ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem) { \
...
returnType Flare::ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem, para1Type para1Name) { \
...
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startDelay);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startDelayMultiplier);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startLifetime);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startLifetimeMultiplier);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startSpeed);
...
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startSize);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startSizeMultiplier);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startSizeX);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startSizeXMultiplier);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startSizeY);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startSizeYMultiplier);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startSizeZ);
...
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startRotation);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startRotationMultiplier);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startRotationX);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startRotationXMultiplier);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startRotationY);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startRotationYMultiplier);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, startRotationZ);
...
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxGradient, startColor);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, Flare::ParticleController::GravitySource, gravitySource);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, Flare::ParticleController::MinMaxCurve, gravityModifier);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, gravityModifierMultiplier);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, Flare::ParticleController::SimulationSpace, simulationSpace);
...
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, Flare::ParticleController::ScalingMode, scalingMode);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, bool, playOnAwake);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, int, maxParticles);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, Flare::ParticleController::EmitterVelocityMode, emitterVelocityMode);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, Flare::ParticleController::StopAction, stopAction);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, Flare::ParticleController::RingBufferMode, ringBufferMode);
DEFINE_FIELD_SETGET_BY_REF(MainModule, main, UnityEngine::Vector2, ringBufferLoopRange);
DEFINE_FIELD_SETGET_DIRECT(MainModule, main, Flare::ParticleController::CullingMode, cullingMode);

DEFINE_FIELD_SETGET_DIRECT(EmissionModule, emission, bool, enabled);
DEFINE_FIELD_SETGET_BY_REF(EmissionModule, emission, Flare::ParticleController::MinMaxCurve, rateOverTime);
DEFINE_FIELD_SETGET_DIRECT(EmissionModule, emission, float, rateOverTimeMultiplier);
DEFINE_FIELD_SETGET_BY_REF(EmissionModule, emission, Flare::ParticleController::MinMaxCurve, rateOverDistance);
DEFINE_FIELD_SETGET_DIRECT(EmissionModule, emission, float, rateOverDistanceMultiplier);
Flare::ParticleController::Burst GetBurst(UnityEngine::ParticleSystem* particleSystem, int index) {
    static auto Func = il2cpp_utils::resolve_icall<void, UnityEngine::ParticleSystem::EmissionModule*, int, Flare::ParticleController::Burst*>("UnityEngine.ParticleSystem/EmissionModule::GetBurst_Injected");
    UnityEngine::ParticleSystem::EmissionModule moduleObj = particleSystem->emission;
    Flare::ParticleController::Burst propertyObj;
    Func(&moduleObj, index, &propertyObj);
    return propertyObj;
}
void SetBurst(UnityEngine::ParticleSystem* particleSystem, int index, Flare::ParticleController::Burst burst) {
    static auto Func = il2cpp_utils::resolve_icall<void, UnityEngine::ParticleSystem::EmissionModule*, int, Flare::ParticleController::Burst*>("UnityEngine.ParticleSystem/EmissionModule::SetBurst_Injected");
    UnityEngine::ParticleSystem::EmissionModule moduleObj = particleSystem->emission;
...
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, Flare::ParticleController::ShapeType, shapeType);
...
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, Flare::ParticleController::ShapeMultiModeValue, radiusMode);
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, float, radiusSpread);
DEFINE_FIELD_SETGET_BY_REF(ShapeModule, shape, Flare::ParticleController::MinMaxCurve, radiusSpeed);
...
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, Flare::ParticleController::MeshShapeType, meshShapeType);
...
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, Flare::ParticleController::ShapeMultiModeValue, meshSpawnMode);
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, float, meshSpawnSpread);
DEFINE_FIELD_SETGET_BY_REF(ShapeModule, shape, Flare::ParticleController::MinMaxCurve, meshSpawnSpeed);
...
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, Flare::ParticleController::ShapeMultiModeValue, arcMode);
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, float, arcSpread);
DEFINE_FIELD_SETGET_BY_REF(ShapeModule, shape, Flare::ParticleController::MinMaxCurve, arcSpeed);
...
DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, Flare::ParticleController::ShapeTextureChannel, textureClipChannel);
...
DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, Flare::ParticleController::CollisionType, type);
DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, Flare::ParticleController::CollisionMode, mode);
DEFINE_FIELD_SETGET_BY_REF(CollisionModule, collision, Flare::ParticleController::MinMaxCurve, dampen);
DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, float, dampenMultiplier);
DEFINE_FIELD_SETGET_BY_REF(CollisionModule, collision, Flare::ParticleController::MinMaxCurve, bounce);
DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, float, bounceMultiplier);
DEFINE_FIELD_SETGET_BY_REF(CollisionModule, collision, Flare::ParticleController::MinMaxCurve, lifetimeLoss);
...
DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, Flare::ParticleController::CollisionQuality, quality);
...
DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, Flare::ParticleController::OverlapAction, inside);
DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, Flare::ParticleController::OverlapAction, outside);
DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, Flare::ParticleController::OverlapAction, enter);
DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, Flare::ParticleController::OverlapAction, exit);
DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, Flare::ParticleController::ColliderQueryMode, colliderQueryMode);
...
DEFINE_VOID_4(SubEmittersModule, subEmitters, AddSubEmitter, UnityEngine::ParticleSystem*, subEmitter, Flare::ParticleController::SubEmitterType, type, Flare::ParticleController::SubEmitterProperties, properties, float, emitProbability);
...
DEFINE_VOID_2(SubEmittersModule, subEmitters, SetSubEmitterType, int, index, Flare::ParticleController::SubEmitterType, type);
DEFINE_VOID_2(SubEmittersModule, subEmitters, SetSubEmitterProperties, int, index, Flare::ParticleController::SubEmitterProperties, properties);
...
DEFINE_RETURN_1(Flare::ParticleController::SubEmitterType, SubEmittersModule, subEmitters, GetSubEmitterType, int, index);
DEFINE_RETURN_1(Flare::ParticleController::SubEmitterProperties, SubEmittersModule, subEmitters, GetSubEmitterProperties, int, index);
...
DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, Flare::ParticleController::AnimationMode, mode);
DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, Flare::ParticleController::AnimationTimeMode, timeMode);
...
DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, Flare::ParticleController::AnimationType, animation);
DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, Flare::ParticleController::AnimationRowMode, rowMode);
DEFINE_FIELD_SETGET_BY_REF(TextureSheetAnimationModule, textureSheetAnimation, Flare::ParticleController::MinMaxCurve, frameOverTime);
DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, float, frameOverTimeMultiplier);
DEFINE_FIELD_SETGET_BY_REF(TextureSheetAnimationModule, textureSheetAnimation, Flare::ParticleController::MinMaxCurve, startFrame);
...
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, x);
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, y);
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, z);
...
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, orbitalX);
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, orbitalY);
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, orbitalZ);
...
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, orbitalOffsetX);
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, orbitalOffsetY);
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, orbitalOffsetZ);
...
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, radial);
DEFINE_FIELD_SETGET_DIRECT(VelocityOverLifetimeModule, velocityOverLifetime, float, radialMultiplier);
DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::MinMaxCurve, speedModifier);
DEFINE_FIELD_SETGET_DIRECT(VelocityOverLifetimeModule, velocityOverLifetime, float, speedModifierMultiplier);
DEFINE_FIELD_SETGET_DIRECT(VelocityOverLifetimeModule, velocityOverLifetime, Flare::ParticleController::SimulationSpace, space);

DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, bool, enabled);
DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, Flare::ParticleController::MinMaxCurve, limitX);
DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, float, limitXMultiplier);
DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, Flare::ParticleController::MinMaxCurve, limitY);
DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, float, limitYMultiplier);
DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, Flare::ParticleController::MinMaxCurve, limitZ);
DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, float, limitZMultiplier);
DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, Flare::ParticleController::MinMaxCurve, limit);
...
DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, Flare::ParticleController::SimulationSpace, space);
DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, Flare::ParticleController::MinMaxCurve, drag);
...
DEFINE_FIELD_SETGET_DIRECT(InheritVelocityModule, inheritVelocity, Flare::ParticleController::InheritVelocityMode, mode);
DEFINE_FIELD_SETGET_BY_REF(InheritVelocityModule, inheritVelocity, Flare::ParticleController::MinMaxCurve, curve);
...
DEFINE_FIELD_SETGET_BY_REF(LifetimeByEmitterSpeedModule, lifetimeByEmitterSpeed, Flare::ParticleController::MinMaxCurve, curve);
...
DEFINE_FIELD_SETGET_BY_REF(ForceOverLifetimeModule, forceOverLifetime, Flare::ParticleController::MinMaxCurve, x);
DEFINE_FIELD_SETGET_BY_REF(ForceOverLifetimeModule, forceOverLifetime, Flare::ParticleController::MinMaxCurve, y);
DEFINE_FIELD_SETGET_BY_REF(ForceOverLifetimeModule, forceOverLifetime, Flare::ParticleController::MinMaxCurve, z);
...
DEFINE_FIELD_SETGET_DIRECT(ForceOverLifetimeModule, forceOverLifetime, Flare::ParticleController::SimulationSpace, space);
...
DEFINE_FIELD_SETGET_BY_REF(ColorOverLifetimeModule, colorOverLifetime, Flare::ParticleController::MinMaxGradient, color);

DEFINE_FIELD_SETGET_DIRECT(ColorBySpeedModule, colorBySpeed, bool, enabled);
DEFINE_FIELD_SETGET_BY_REF(ColorBySpeedModule, colorBySpeed, Flare::ParticleController::MinMaxGradient, color);
...
DEFINE_FIELD_SETGET_BY_REF(SizeOverLifetimeModule, sizeOverLifetime, Flare::ParticleController::MinMaxCurve, size);
DEFINE_FIELD_SETGET_DIRECT(SizeOverLifetimeModule, sizeOverLifetime, float, sizeMultiplier);
DEFINE_FIELD_SETGET_BY_REF(SizeOverLifetimeModule, sizeOverLifetime, Flare::ParticleController::MinMaxCurve, x);
DEFINE_FIELD_SETGET_DIRECT(SizeOverLifetimeModule, sizeOverLifetime, float, xMultiplier);
DEFINE_FIELD_SETGET_BY_REF(SizeOverLifetimeModule, sizeOverLifetime, Flare::ParticleController::MinMaxCurve, y);
DEFINE_FIELD_SETGET_DIRECT(SizeOverLifetimeModule, sizeOverLifetime, float, yMultiplier);
DEFINE_FIELD_SETGET_BY_REF(SizeOverLifetimeModule, sizeOverLifetime, Flare::ParticleController::MinMaxCurve, z);
...
DEFINE_FIELD_SETGET_BY_REF(SizeBySpeedModule, sizeBySpeed, Flare::ParticleController::MinMaxCurve, size);
DEFINE_FIELD_SETGET_DIRECT(SizeBySpeedModule, sizeBySpeed, float, sizeMultiplier);
DEFINE_FIELD_SETGET_BY_REF(SizeBySpeedModule, sizeBySpeed, Flare::ParticleController::MinMaxCurve, x);
DEFINE_FIELD_SETGET_DIRECT(SizeBySpeedModule, sizeBySpeed, float, xMultiplier);
DEFINE_FIELD_SETGET_BY_REF(SizeBySpeedModule, sizeBySpeed, Flare::ParticleController::MinMaxCurve, y);
DEFINE_FIELD_SETGET_DIRECT(SizeBySpeedModule, sizeBySpeed, float, yMultiplier);
DEFINE_FIELD_SETGET_BY_REF(SizeBySpeedModule, sizeBySpeed, Flare::ParticleController::MinMaxCurve, z);
...
DEFINE_FIELD_SETGET_BY_REF(RotationOverLifetimeModule, rotationOverLifetime, Flare::ParticleController::MinMaxCurve, x);
DEFINE_FIELD_SETGET_DIRECT(RotationOverLifetimeModule, rotationOverLifetime, float, xMultiplier);
DEFINE_FIELD_SETGET_BY_REF(RotationOverLifetimeModule, rotationOverLifetime, Flare::ParticleController::MinMaxCurve, y);
DEFINE_FIELD_SETGET_DIRECT(RotationOverLifetimeModule, rotationOverLifetime, float, yMultiplier);
DEFINE_FIELD_SETGET_BY_REF(RotationOverLifetimeModule, rotationOverLifetime, Flare::ParticleController::MinMaxCurve, z);
...
DEFINE_FIELD_SETGET_BY_REF(RotationBySpeedModule, rotationBySpeed, Flare::ParticleController::MinMaxCurve, x);
DEFINE_FIELD_SETGET_DIRECT(RotationBySpeedModule, rotationBySpeed, float, xMultiplier);
DEFINE_FIELD_SETGET_BY_REF(RotationBySpeedModule, rotationBySpeed, Flare::ParticleController::MinMaxCurve, y);
DEFINE_FIELD_SETGET_DIRECT(RotationBySpeedModule, rotationBySpeed, float, yMultiplier);
DEFINE_FIELD_SETGET_BY_REF(RotationBySpeedModule, rotationBySpeed, Flare::ParticleController::MinMaxCurve, z);
...
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, strength);
DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, strengthMultiplier);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, strengthX);
DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, strengthXMultiplier);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, strengthY);
DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, strengthYMultiplier);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, strengthZ);
...
DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, Flare::ParticleController::NoiseQuality, quality);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, scrollSpeed);
...
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, remap);
DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, remapMultiplier);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, remapX);
DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, remapXMultiplier);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, remapY);
DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, remapYMultiplier);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, remapZ);
DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, remapZMultiplier);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, positionAmount);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, rotationAmount);
DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, Flare::ParticleController::MinMaxCurve, sizeAmount);
...
DEFINE_FIELD_SETGET_BY_REF(LightsModule, lights, Flare::ParticleController::MinMaxCurve, range);
DEFINE_FIELD_SETGET_DIRECT(LightsModule, lights, float, rangeMultiplier);
DEFINE_FIELD_SETGET_BY_REF(LightsModule, lights, Flare::ParticleController::MinMaxCurve, intensity);
...
DEFINE_FIELD_SETGET_DIRECT(TrailModule, trails, Flare::ParticleController::TrailMode, mode);
DEFINE_FIELD_SETGET_DIRECT(TrailModule, trails, float, ratio);
DEFINE_FIELD_SETGET_BY_REF(TrailModule, trails, Flare::ParticleController::MinMaxCurve, lifetime);
...
DEFINE_FIELD_SETGET_DIRECT(TrailModule, trails, Flare::ParticleController::TrailTextureMode, textureMode);
...
DEFINE_FIELD_SETGET_BY_REF(TrailModule, trails, Flare::ParticleController::MinMaxGradient, colorOverLifetime);
DEFINE_FIELD_SETGET_BY_REF(TrailModule, trails, Flare::ParticleController::MinMaxCurve, widthOverTrail);
DEFINE_FIELD_SETGET_DIRECT(TrailModule, trails, float, widthOverTrailMultiplier);
DEFINE_FIELD_SETGET_BY_REF(TrailModule, trails, Flare::ParticleController::MinMaxGradient, colorOverTrail);
