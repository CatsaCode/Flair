...
namespace Flair {
    ...
    propertyType ParticleController::moduleType::get_##propertyName(UnityEngine::ParticleSystem* particleSystem) { \
    ...
    void ParticleController::moduleType::set_##propertyName(UnityEngine::ParticleSystem* particleSystem, propertyType value) { \
    ...
    void ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem, para1Type para1Name) { \
    ...
    void ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem, para1Type para1Name, para2Type para2Name) { \
    ...
    void ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem, para1Type para1Name, para2Type para2Name, para3Type para3Name, para4Type para4Name) { \
    ...
    returnType ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem) { \
    ...
    returnType ParticleController::moduleType::funcName(UnityEngine::ParticleSystem* particleSystem, para1Type para1Name) { \
    ...
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startDelay);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startDelayMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startLifetime);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startLifetimeMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startSpeed);
    ...
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startSize);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startSizeMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startSizeX);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startSizeXMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startSizeY);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startSizeYMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startSizeZ);
    ...
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startRotation);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startRotationMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startRotationX);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startRotationXMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startRotationY);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, startRotationYMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, startRotationZ);
    ...
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxGradient, startColor);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, ParticleController::GravitySource, gravitySource);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, ParticleController::MinMaxCurve, gravityModifier);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, float, gravityModifierMultiplier);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, ParticleController::SimulationSpace, simulationSpace);
    ...
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, ParticleController::ScalingMode, scalingMode);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, bool, playOnAwake);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, int, maxParticles);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, ParticleController::EmitterVelocityMode, emitterVelocityMode);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, ParticleController::StopAction, stopAction);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, ParticleController::RingBufferMode, ringBufferMode);
    DEFINE_FIELD_SETGET_BY_REF(MainModule, main, UnityEngine::Vector2, ringBufferLoopRange);
    DEFINE_FIELD_SETGET_DIRECT(MainModule, main, ParticleController::CullingMode, cullingMode);

    DEFINE_FIELD_SETGET_DIRECT(EmissionModule, emission, bool, enabled);
    DEFINE_FIELD_SETGET_BY_REF(EmissionModule, emission, ParticleController::MinMaxCurve, rateOverTime);
    DEFINE_FIELD_SETGET_DIRECT(EmissionModule, emission, float, rateOverTimeMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(EmissionModule, emission, ParticleController::MinMaxCurve, rateOverDistance);
    DEFINE_FIELD_SETGET_DIRECT(EmissionModule, emission, float, rateOverDistanceMultiplier);
    ParticleController::Burst GetBurst(UnityEngine::ParticleSystem* particleSystem, int index) {
        static auto Func = il2cpp_utils::resolve_icall<void, UnityEngine::ParticleSystem::EmissionModule*, int, ParticleController::Burst*>("UnityEngine.ParticleSystem/EmissionModule::GetBurst_Injected");
        UnityEngine::ParticleSystem::EmissionModule moduleObj = particleSystem->emission;
        ParticleController::Burst propertyObj;
        Func(&moduleObj, index, &propertyObj);
        return propertyObj;
    }
    void SetBurst(UnityEngine::ParticleSystem* particleSystem, int index, ParticleController::Burst burst) {
        static auto Func = il2cpp_utils::resolve_icall<void, UnityEngine::ParticleSystem::EmissionModule*, int, ParticleController::Burst*>("UnityEngine.ParticleSystem/EmissionModule::SetBurst_Injected");
        UnityEngine::ParticleSystem::EmissionModule moduleObj = particleSystem->emission;
    ...
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, ParticleController::ShapeType, shapeType);
    ...
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, ParticleController::ShapeMultiModeValue, radiusMode);
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, float, radiusSpread);
    DEFINE_FIELD_SETGET_BY_REF(ShapeModule, shape, ParticleController::MinMaxCurve, radiusSpeed);
    ...
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, ParticleController::MeshShapeType, meshShapeType);
    ...
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, ParticleController::ShapeMultiModeValue, meshSpawnMode);
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, float, meshSpawnSpread);
    DEFINE_FIELD_SETGET_BY_REF(ShapeModule, shape, ParticleController::MinMaxCurve, meshSpawnSpeed);
    ...
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, ParticleController::ShapeMultiModeValue, arcMode);
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, float, arcSpread);
    DEFINE_FIELD_SETGET_BY_REF(ShapeModule, shape, ParticleController::MinMaxCurve, arcSpeed);
    ...
    DEFINE_FIELD_SETGET_DIRECT(ShapeModule, shape, ParticleController::ShapeTextureChannel, textureClipChannel);
    ...
    DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, ParticleController::CollisionType, type);
    DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, ParticleController::CollisionMode, mode);
    DEFINE_FIELD_SETGET_BY_REF(CollisionModule, collision, ParticleController::MinMaxCurve, dampen);
    DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, float, dampenMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(CollisionModule, collision, ParticleController::MinMaxCurve, bounce);
    DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, float, bounceMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(CollisionModule, collision, ParticleController::MinMaxCurve, lifetimeLoss);
    ...
    DEFINE_FIELD_SETGET_DIRECT(CollisionModule, collision, ParticleController::CollisionQuality, quality);
    ...
    DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, ParticleController::OverlapAction, inside);
    DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, ParticleController::OverlapAction, outside);
    DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, ParticleController::OverlapAction, enter);
    DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, ParticleController::OverlapAction, exit);
    DEFINE_FIELD_SETGET_DIRECT(TriggerModule, trigger, ParticleController::ColliderQueryMode, colliderQueryMode);
    ...
    DEFINE_RETURN_1(ParticleController::SubEmitterType, SubEmittersModule, subEmitters, GetSubEmitterType, int, index);
    DEFINE_RETURN_1(ParticleController::SubEmitterProperties, SubEmittersModule, subEmitters, GetSubEmitterProperties, int, index);
    ...
    DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, ParticleController::AnimationMode, mode);
    DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, ParticleController::AnimationTimeMode, timeMode);
    ...
    DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, ParticleController::AnimationType, animation);
    DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, ParticleController::AnimationRowMode, rowMode);
    DEFINE_FIELD_SETGET_BY_REF(TextureSheetAnimationModule, textureSheetAnimation, ParticleController::MinMaxCurve, frameOverTime);
    DEFINE_FIELD_SETGET_DIRECT(TextureSheetAnimationModule, textureSheetAnimation, float, frameOverTimeMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(TextureSheetAnimationModule, textureSheetAnimation, ParticleController::MinMaxCurve, startFrame);
    ...
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, x);
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, y);
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, z);
    ...
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, orbitalX);
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, orbitalY);
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, orbitalZ);
    ...
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, orbitalOffsetX);
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, orbitalOffsetY);
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, orbitalOffsetZ);
    ...
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, radial);
    DEFINE_FIELD_SETGET_DIRECT(VelocityOverLifetimeModule, velocityOverLifetime, float, radialMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::MinMaxCurve, speedModifier);
    DEFINE_FIELD_SETGET_DIRECT(VelocityOverLifetimeModule, velocityOverLifetime, float, speedModifierMultiplier);
    DEFINE_FIELD_SETGET_DIRECT(VelocityOverLifetimeModule, velocityOverLifetime, ParticleController::SimulationSpace, space);

    DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, bool, enabled);
    DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, ParticleController::MinMaxCurve, limitX);
    DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, float, limitXMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, ParticleController::MinMaxCurve, limitY);
    DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, float, limitYMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, ParticleController::MinMaxCurve, limitZ);
    DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, float, limitZMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, ParticleController::MinMaxCurve, limit);
    ...
    DEFINE_FIELD_SETGET_DIRECT(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, ParticleController::SimulationSpace, space);
    DEFINE_FIELD_SETGET_BY_REF(LimitVelocityOverLifetimeModule, limitVelocityOverLifetime, ParticleController::MinMaxCurve, drag);
    ...
    DEFINE_FIELD_SETGET_DIRECT(InheritVelocityModule, inheritVelocity, ParticleController::InheritVelocityMode, mode);
    DEFINE_FIELD_SETGET_BY_REF(InheritVelocityModule, inheritVelocity, ParticleController::MinMaxCurve, curve);
    ...
    DEFINE_FIELD_SETGET_BY_REF(LifetimeByEmitterSpeedModule, lifetimeByEmitterSpeed, ParticleController::MinMaxCurve, curve);
    ...
    DEFINE_FIELD_SETGET_BY_REF(ForceOverLifetimeModule, forceOverLifetime, ParticleController::MinMaxCurve, x);
    DEFINE_FIELD_SETGET_BY_REF(ForceOverLifetimeModule, forceOverLifetime, ParticleController::MinMaxCurve, y);
    DEFINE_FIELD_SETGET_BY_REF(ForceOverLifetimeModule, forceOverLifetime, ParticleController::MinMaxCurve, z);
    ...
    DEFINE_FIELD_SETGET_DIRECT(ForceOverLifetimeModule, forceOverLifetime, ParticleController::SimulationSpace, space);
    ...
    DEFINE_FIELD_SETGET_BY_REF(ColorOverLifetimeModule, colorOverLifetime, ParticleController::MinMaxGradient, color);

    DEFINE_FIELD_SETGET_DIRECT(ColorBySpeedModule, colorBySpeed, bool, enabled);
    DEFINE_FIELD_SETGET_BY_REF(ColorBySpeedModule, colorBySpeed, ParticleController::MinMaxGradient, color);
    ...
    DEFINE_FIELD_SETGET_BY_REF(SizeOverLifetimeModule, sizeOverLifetime, ParticleController::MinMaxCurve, size);
    DEFINE_FIELD_SETGET_DIRECT(SizeOverLifetimeModule, sizeOverLifetime, float, sizeMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(SizeOverLifetimeModule, sizeOverLifetime, ParticleController::MinMaxCurve, x);
    DEFINE_FIELD_SETGET_DIRECT(SizeOverLifetimeModule, sizeOverLifetime, float, xMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(SizeOverLifetimeModule, sizeOverLifetime, ParticleController::MinMaxCurve, y);
    DEFINE_FIELD_SETGET_DIRECT(SizeOverLifetimeModule, sizeOverLifetime, float, yMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(SizeOverLifetimeModule, sizeOverLifetime, ParticleController::MinMaxCurve, z);
    ...
    DEFINE_FIELD_SETGET_BY_REF(SizeBySpeedModule, sizeBySpeed, ParticleController::MinMaxCurve, size);
    DEFINE_FIELD_SETGET_DIRECT(SizeBySpeedModule, sizeBySpeed, float, sizeMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(SizeBySpeedModule, sizeBySpeed, ParticleController::MinMaxCurve, x);
    DEFINE_FIELD_SETGET_DIRECT(SizeBySpeedModule, sizeBySpeed, float, xMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(SizeBySpeedModule, sizeBySpeed, ParticleController::MinMaxCurve, y);
    DEFINE_FIELD_SETGET_DIRECT(SizeBySpeedModule, sizeBySpeed, float, yMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(SizeBySpeedModule, sizeBySpeed, ParticleController::MinMaxCurve, z);
    ...
    DEFINE_FIELD_SETGET_BY_REF(RotationOverLifetimeModule, rotationOverLifetime, ParticleController::MinMaxCurve, x);
    DEFINE_FIELD_SETGET_DIRECT(RotationOverLifetimeModule, rotationOverLifetime, float, xMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(RotationOverLifetimeModule, rotationOverLifetime, ParticleController::MinMaxCurve, y);
    DEFINE_FIELD_SETGET_DIRECT(RotationOverLifetimeModule, rotationOverLifetime, float, yMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(RotationOverLifetimeModule, rotationOverLifetime, ParticleController::MinMaxCurve, z);
    ...
    DEFINE_FIELD_SETGET_BY_REF(RotationBySpeedModule, rotationBySpeed, ParticleController::MinMaxCurve, x);
    DEFINE_FIELD_SETGET_DIRECT(RotationBySpeedModule, rotationBySpeed, float, xMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(RotationBySpeedModule, rotationBySpeed, ParticleController::MinMaxCurve, y);
    DEFINE_FIELD_SETGET_DIRECT(RotationBySpeedModule, rotationBySpeed, float, yMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(RotationBySpeedModule, rotationBySpeed, ParticleController::MinMaxCurve, z);
    ...
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, strength);
    DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, strengthMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, strengthX);
    DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, strengthXMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, strengthY);
    DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, strengthYMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, strengthZ);
    ...
    DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, ParticleController::NoiseQuality, quality);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, scrollSpeed);
    ...
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, remap);
    DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, remapMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, remapX);
    DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, remapXMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, remapY);
    DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, remapYMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, remapZ);
    DEFINE_FIELD_SETGET_DIRECT(NoiseModule, noise, float, remapZMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, positionAmount);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, rotationAmount);
    DEFINE_FIELD_SETGET_BY_REF(NoiseModule, noise, ParticleController::MinMaxCurve, sizeAmount);
    ...
    DEFINE_FIELD_SETGET_BY_REF(LightsModule, lights, ParticleController::MinMaxCurve, range);
    DEFINE_FIELD_SETGET_DIRECT(LightsModule, lights, float, rangeMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(LightsModule, lights, ParticleController::MinMaxCurve, intensity);
    ...
    DEFINE_FIELD_SETGET_DIRECT(TrailModule, trails, ParticleController::TrailMode, mode);
    DEFINE_FIELD_SETGET_DIRECT(TrailModule, trails, float, ratio);
    DEFINE_FIELD_SETGET_BY_REF(TrailModule, trails, ParticleController::MinMaxCurve, lifetime);
    ...
    DEFINE_FIELD_SETGET_DIRECT(TrailModule, trails, ParticleController::TrailTextureMode, textureMode);
    ...
    DEFINE_FIELD_SETGET_BY_REF(TrailModule, trails, ParticleController::MinMaxGradient, colorOverLifetime);
    DEFINE_FIELD_SETGET_BY_REF(TrailModule, trails, ParticleController::MinMaxCurve, widthOverTrail);
    DEFINE_FIELD_SETGET_DIRECT(TrailModule, trails, float, widthOverTrailMultiplier);
    DEFINE_FIELD_SETGET_BY_REF(TrailModule, trails, ParticleController::MinMaxGradient, colorOverTrail);
