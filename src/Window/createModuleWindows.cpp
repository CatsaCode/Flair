...
namespace Flair::Window {
    ...
    Window* CreateMainModuleWindow(Window* parent, UnityEngine::ParticleSystem* particleSystem) {
        ...
        CreateMinMaxCurveSetting(row->get_transform(), "", "", ParticleController::MainModule::get_startSizeX(particleSystem), [particleSystem](ParticleController::MinMaxCurve value){ParticleController::MainModule::set_startSizeX(particleSystem, value);});
        CreateMinMaxCurveSetting(row->get_transform(), "", "", ParticleController::MainModule::get_startSizeY(particleSystem), [particleSystem](ParticleController::MinMaxCurve value){ParticleController::MainModule::set_startSizeY(particleSystem, value);});
        CreateMinMaxCurveSetting(row->get_transform(), "", "", ParticleController::MainModule::get_startSizeZ(particleSystem), [particleSystem](ParticleController::MinMaxCurve value){ParticleController::MainModule::set_startSizeZ(particleSystem, value);});
        ...
        rowLayout->set_childControlWidth(true);
        rowLayout->set_childControlHeight(false);
        CreateMinMaxCurveSetting(row->get_transform(), "", "", ParticleController::MainModule::get_startRotationX(particleSystem), [particleSystem](ParticleController::MinMaxCurve value){ParticleController::MainModule::set_startRotationX(particleSystem, value);});
        CreateMinMaxCurveSetting(row->get_transform(), "", "", ParticleController::MainModule::get_startRotationY(particleSystem), [particleSystem](ParticleController::MinMaxCurve value){ParticleController::MainModule::set_startRotationY(particleSystem, value);});
        CreateMinMaxCurveSetting(row->get_transform(), "", "", ParticleController::MainModule::get_startRotationZ(particleSystem), [particleSystem](ParticleController::MinMaxCurve value){ParticleController::MainModule::set_startRotationZ(particleSystem, value);});
