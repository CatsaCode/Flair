...
void logHierarchy(UnityEngine::Transform* transform, const bool listComponents = false, const int depthUp = 0, const int depthDown = 1000, std::string depthStr = "");
